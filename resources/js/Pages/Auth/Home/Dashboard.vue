    ...
    <q-page class="q-pa-md column q-gutter-y-sm">
        ...
        <div>
            ...
            <div class="containerHome row">
                <q-card class="cardHome col-7 q-mb-lg row justify-center items-center">
                    <q-card-section class="containerInfo col row justify-between items-start">
                        <div class="column items-start q-gutter-y-lg">
                            <div>
                                <h2 class="title">Hi, {{ user.user.name }}</h2>
                            ...
                            <div class="row q-gutter-x-sm items-center">
                                ...
                                <div>
                                    ...
                                    <template v-if="user.access">
                                        <span v-if="user.user.groups[0].name == 'member'">2</span>
                                        <span v-if="user.user.groups[0].name == 'administrator'">10</span>
                                    </template>
                                </div>
                            </div>
                ...
                <div class="Peer col column q-gutter-y-md q-pa-md">
                    <div class="row justify-between">
                        ...
                        <span>
                            <router-link :to="{ name: 'peers' }" class="enlace">See All</router-link>
                        </span>
                    </div>
        ...
        <div class="Instructions column q-gutter-y-lg">
            <div class="row justify-between instructionsTitle">
                ...
                <span>
                    <router-link :to="{ name: 'instructions' }" class="enlace">See All</router-link>
                </span>
            </div>
    ...
    data() {
        return {
            ...
            instructions: [
                {
                    title: "Create a Peer",
                    description: 'Go to the "Peers" section and create a new peer.',
                    image: 'img/key.png',
                    number: 1
                },
                {
                ...
                {
                    title: "Scan QR code",
                    description: "Download or scan the QR code to configure WireGuard.",
                    image: 'img/QR.png',
                    number: 3
                },
            ],
            ...
            try {
                ...
                if (res.status === 200) {
                    ...
                    if(res.data.data.length != 0) {
                        let count = res.data.data.length < 2 ? res.data.data.length : 2;
